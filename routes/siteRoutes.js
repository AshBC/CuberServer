...
//         const VList = JSON.parse(loadVideoData());
//         console.log("videos patch");
//         const editLikes = {
//             likes: req.body.likes,
//         };
//         const filterItems = VList.filter((item) => item.id === req.params.id);
//         filterItems.push(editLikes);

//         console.log(filterItems);
//         fs.writeFileSync("./data/videos.json", JSON.stringify(filterItems));

//         res.json({
//             message: "posted new likes",
//         });
// });
